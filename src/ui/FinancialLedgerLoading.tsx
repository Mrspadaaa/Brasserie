...
export function FinancialLedgerLoading() {
  ...
  return <div className="max-w-sm text-center text-sm leading-relaxed space-y-3" role="status">
    ...
    <p className="text-cave-400 text-xs">La première ouverture reprend les années conservées. Les prochaines ouvertures synchroniseront seulement les changements.</p>
