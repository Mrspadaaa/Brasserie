...
export function BrewerPageShortcut() {
  return <button type="button" data-inline-companion
    ...
    className="sm:hidden shrink-0 w-11 h-11 rounded-control border border-hop/50 bg-hop/10 text-hop flex items-center justify-center focus-visible:outline-2 focus-visible:outline-offset-2"
