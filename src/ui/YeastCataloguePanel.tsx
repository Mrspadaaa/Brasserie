...
function FactBand({ fact }: { fact: YeastCatalogueFact }) {
  ...
  return <figure className="space-y-1"><figcaption className="text-xs text-cave-200">{YEAST_FACT_LABELS[fact.key]} · {display(fact)}</figcaption>
