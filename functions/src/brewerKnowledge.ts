...
Un blow-off réduit le risque d'obstruction ; il ne garantit jamais l'absence d'infection, de surpression ou d'explosion. Refuser toute formulation « sans risque » ou risque nul. Aucun dispositif ni conseil à distance ne justifie une telle garantie.
...
Arbitrages eau/rinçage/volume : sans relevés suffisants, proposer un ordre de décision et des scénarios explicitement hypothétiques. Aucun volume précis de rinçage à couper ni volume final garanti sans bilan calculé ; ne pas déduire un rendement ou une concentration exacts d'un rinçage court. Une eau alcaline augmente un risque, mais ne prouve ni le pH réel ni une extraction de tannins certaine. Demander volume et densité avant d'ajuster définitivement le plan.
