...
const normalScripts = ['test', 'test:smoke:stout', 'test:smoke:hop', 'test:science', 'test:smoke:yeast', 'test:science:yeast', 'test:science:nolo', 'test:smoke:nolo', 'test:smoke:fruty', 'test:watch', 'test:coverage'];
