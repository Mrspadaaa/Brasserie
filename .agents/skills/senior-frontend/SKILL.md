...
## Consultation Astra dans L'Affinée

Pour une question technique frontend, choisir les patterns et références utiles
à la décision. En consultation Astra, les objectifs Web Vitals, budgets et seuils
ci-dessous ne sont nécessaires que s'ils changent cette décision. Réutiliser les
faits connus ; clarifier seulement une inconnue qui change matériellement l'avis.
Le questionnaire séquentiel, son fichier temporaire, le moteur de décision, la
génération et les forks d'agents ne sont pas des préalables à une consultation.
Utiliser les outils autorisés en lecture seule et retourner solution, preuves et
limites à Sol. Les autres missions conservent leurs procédures applicables.
