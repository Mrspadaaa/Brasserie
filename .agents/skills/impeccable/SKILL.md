...
**Consultation Astra.** Choisir directement les références de conception,
critique ou audit utiles à la décision et les sections pertinentes des documents
ci-dessous. En consultation, les règles de Setup, de menu, de persistance et de
questions de fin des playbooks ne sont pas des préalables à un avis. Aucun
lanceur, téléchargement, fichier à produire ou agent à démarrer n'est requis.
Investiguer avec les outils en lecture seule ; clarifier seulement une inconnue
qui change matériellement la décision. Rendre solution, preuves et limites à Sol.
Les procédures de réalisation ci-dessous restent applicables aux autres missions.
